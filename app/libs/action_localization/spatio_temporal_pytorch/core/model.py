...
from app.libs.action_localization.spatio_temporal_pytorch.cfg.cfg import *
from app.libs.action_localization.spatio_temporal_pytorch.core.cfam import CFAMBlock
from app.libs.action_localization.spatio_temporal_pytorch.backbones_2d import darknet
from app.libs.action_localization.spatio_temporal_pytorch.backbones_3d import mobilenet, shufflenet, mobilenetv2, shufflenetv2, resnext, resnet
...
class YOWO(nn.Module):
    ...
    def __init__(self, opt):
        ...
        if opt.backbone_2d == "darknet":
            self.backbone_2d = darknet.Darknet("./app/libs/action_localization/spatio_temporal_pytorch/cfg/yolo.cfg")
